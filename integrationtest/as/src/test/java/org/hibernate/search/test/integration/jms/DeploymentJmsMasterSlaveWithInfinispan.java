...
/**
 * Create deployments for JMS Master/Slave backend using Infinispan as directory provider.
 * Make sure to test for a secured JMS environment.
 *
 * @author Davide D'Alto
 * @author Sanne Grinovero
 */
public final class DeploymentJmsMasterSlaveWithInfinispan {

	private DeploymentJmsMasterSlaveWithInfinispan() {
		//not allowed
	}
	...
	private static PersistenceDescriptor masterPersistenceXml(String name) throws Exception {
		return commonUnitDef( name, "infinispan" ).up().up();
	}

	private static PersistenceDescriptor slavePersistenceXml(String name)
			throws Exception {
		return commonUnitDef( name, "infinispan" )
					.createProperty()
	...
	private static Properties<PersistenceUnit<PersistenceDescriptor>> commonUnitDef(String name, String directoryProvider)
			throws Exception {
