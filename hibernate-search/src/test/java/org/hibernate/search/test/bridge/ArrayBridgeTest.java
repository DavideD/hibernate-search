...
public class ArrayBridgeTest extends SearchTestCase {
	...
	public void testSearchNullEntry() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<ArrayBridgeTestEntity> results = findResults( fullTextSession, "nullIndexed", ArrayBridgeTestEntity.NULL_TOKEN );
	...
	public void testSearchNullEmbedded() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<ArrayBridgeTestEntity> results = findEmbeddedNullResults( fullTextSession, "nullIndexed", ArrayBridgeTestEntity.NULL_EMBEDDED );
	...
	public void testSearchNullNumericEmbedded() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<ArrayBridgeTestEntity> results = findEmbeddedNullResults( fullTextSession, "embeddedNum", ArrayBridgeTestEntity.NULL_EMBEDDED_NUMERIC );
	...
	public void testSearchNullNumericEntry() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<ArrayBridgeTestEntity> results = findResults( fullTextSession, "numericNullIndexed", ArrayBridgeTestEntity.NULL_NUMERIC_TOKEN );
	...
	private List<ArrayBridgeTestEntity> findEmbeddedNullResults(Session s, String fieldName, Object value) throws ParseException {
