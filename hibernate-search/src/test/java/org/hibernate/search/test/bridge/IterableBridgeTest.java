...
public class IterableBridgeTest extends SearchTestCase {
	...
	public void testSearchNullEmbedded() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<IterableBridgeTestEntity> results = findEmbeddedNullResults( fullTextSession, "nullIndexed", IterableBridgeTestEntity.NULL_EMBEDDED );
	...
	public void testSearchNullNumericEmbedded() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<IterableBridgeTestEntity> results = findEmbeddedNullResults( fullTextSession, "embeddedNum", IterableBridgeTestEntity.NULL_EMBEDDED_NUMERIC );
	...
	private List<IterableBridgeTestEntity> findEmbeddedNullResults(Session s, String fieldName, Object value) throws ParseException {
