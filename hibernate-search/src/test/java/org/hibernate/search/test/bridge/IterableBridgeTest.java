...
public class IterableBridgeTest extends SearchTestCase {
	...
	private IterableBridgeTestEntity nullEmbeddedIndexed;
	...
	public void testNullIndexing() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<IterableBridgeTestEntity> results = findResults( fullTextSession, "embedded", null );
	...
	public void testNumericNullIndexing() throws Exception {
		Transaction tx = fullTextSession.beginTransaction();
		{
			List<IterableBridgeTestEntity> results = findResults( fullTextSession, "embeddedNum", null );
