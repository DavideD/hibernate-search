...
/**
 * Stores each entry of an {@code Iterable} calling the method {@link IterableBridge#indexNotNullEntry(String, Object, Document, LuceneOptions)}.
 *
 * The bridge manages {@code null} elements or a {@code null} collection in accordance to the {@link LuceneOptions#indexNullAs()} value.
 *
 * @author Davide D'Alto
 */
public abstract class IterableBridge implements FieldBridge {
	...
	public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
		if ( value == null ) {
			...
			indexNotNullCollection( name, value, document, luceneOptions );
		}
	}

	private void indexNotNullCollection(String name, Object value, Document document, LuceneOptions luceneOptions) {
	...
	/**
	 * Index the given not {@code null} entry from an {@code Iterable}.
	 *
