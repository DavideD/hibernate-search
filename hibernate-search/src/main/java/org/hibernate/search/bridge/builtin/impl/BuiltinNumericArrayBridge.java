...
/**
 * @author Davide D'Alto <daltodavide@gmail.com>
 */
public class BuiltinNumericArrayBridge extends ArrayBridge implements StringBridge {
	...
	protected void indexNotNullEntry(String name, Object entry, Document document, LuceneOptions luceneOptions) {
		luceneOptions.addNumericFieldToDocument( name, entry, document );
	}
